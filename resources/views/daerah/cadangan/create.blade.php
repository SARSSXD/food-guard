<div class="modal fade" id="createCadanganModal" tabindex="-1" aria-labelledby="createCadanganModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createCadanganModalLabel">Tambah Data Cadangan Pangan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('daerah.cadangan.store') }}" method="POST">
                @csrf
