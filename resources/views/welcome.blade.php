...
@section('content')
    ...
    <section id="hero" class="hero section dark-background">
        <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            <div class="carousel-item active">
                <img src="{{ asset('assetslp/img/lahan_pertanian.jpg') }}" alt="">
                <div class="carousel-container">
                    <h2>Ketahanan Pangan, Kunci Kesejahteraan Bangsa</h2>
                    <p>Bangsa yang mampu memenuhi kebutuhan pangannya akan lebih stabil dan sejahtera. Ketahanan pangan
                        menjadi fondasi bagi pertumbuhan ekonomi dan kualitas hidup rakyat.</p>
                </div>
            </div><!-- End Carousel Item -->

            <div class="carousel-item">
                <img src="{{ asset('assetslp/img/jagung.jpeg') }}" alt="">
                <div class="carousel-container">
                    <h2>Edukasi Gizi, Awal dari Ketahanan</h2>
                    <p>Pemahaman masyarakat tentang gizi membentuk pola konsumsi yang sehat. Ini mendukung sistem pangan
                        yang berkelanjutan dan kuat.</p>
                </div>
            </div><!-- End Carousel Item -->

            <div class="carousel-item">
                <img src="{{ asset('assetslp/img/petani.jpg') }}" alt="">
                <div class="carousel-container">
                    <h2>Pangan Aman, Rakyat Tenang</h2>
                    <p>Akses terhadap pangan yang bersih dan sehat menjaga kesehatan publik. Ini menciptakan rasa aman dan
                        kepercayaan masyarakat terhadap sistem pangan.</p>
                </div>
            </div><!-- End Carousel Item -->

            <div class="carousel-item">
                <img src="{{ asset('assetslp/img/produksi_beras.jpg') }}" alt="">
                <div class="carousel-container">
                    <h2>Pangan Cukup, Hidup Sehat, Masa Depan Cerah</h2>
                    <p>Kecukupan pangan menjamin pertumbuhan dan produktivitas. Ini membuka peluang masa depan yang lebih
                        baik bagi generasi mendatang.</p>
                </div>
            </div><!-- End Carousel Item -->

            <div class="carousel-item">
                <img src="{{ asset('assetslp/img/pangan.jpeg') }}" alt="">
                <div class="carousel-container">
                    <h2>Jaga Pangan, Jaga Masa Depan</h2>
                    <p>Menjaga produksi dan distribusi pangan berarti melindungi keberlanjutan hidup. Masa depan bergantung
                        pada bagaimana kita mengelola pangan hari ini.</p>
                </div>
            </div><!-- End Carousel Item -->
    ...
    <section id="services" class="services section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>PERTANIAN</h2>
            <p>Faktor Kunci dalam Keberhasilan Pertanian</p>
                ...
                <div class="row g-0">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Tanah Yang subur</h3>
                                <p>
                                    Tanah adalah media utama tumbuh tanaman. Kesuburan tanah menentukan kualitas dan
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Iklim dan Cuaca</h3>
                                <p>
                                    Sinar matahari, curah hujan, suhu, dan kelembapan mempengaruhi pertumbuhan tanaman dan
                                    waktu tanam.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Teknologi Pertanian</h3>
                                <p>
                                    Penggunaan alat, mesin, dan sistem pertanian modern (seperti sensor, drone, irigasi
                                    otomatis) meningkatkan produktivitas dan efisiensi.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Pengendalian Hama dan Penyakit</h3>
                                <p>
                                    Hama dan penyakit dapat merusak hasil panen. Pengendalian bisa dilakukan secara kimiawi,
                                    biologis, atau organik.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Benih/Bibit Berkualitas</h3>
                                <p>
                                    Pemilihan benih unggul menentukan ketahanan tanaman terhadap penyakit dan produktivitas.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Akses ke Pasar dan Distribusi</h3>
                                <p>
                                    Tanpa jalur distribusi yang lancar, hasil panen tidak akan terserap pasar secara
                                    optimal, menyebabkan kerugian.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Air dan Irigasi</h3>
                                <p>
                                    Air sangat penting untuk fotosintesis dan pertumbuhan tanaman. Sistem irigasi yang baik
                                    membantu mengatur pasokan air.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Dukungan Pemerintah dan Kebijakan</h3>
                                <p>
                                    Subsidi, pelatihan, perlindungan harga, serta regulasi lahan sangat mempengaruhi
    ...
    <!-- About Section -->
    <section id="about" class="about section" style="background-color: #2e7d32; padding: 60px 0;">
        <div class="container text-center" data-aos="fade-down" data-aos-duration="1000">
            <h2 class="text-white mb-4" style="font-weight: bold;">Peta Ketahanan Pangan 2024</h2>
            <div class="row justify-content-center">
                <div class="col-lg-10" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('assetslp/img/peta.png') }}" alt="Peta Ketahanan Pangan"
                        class="img-fluid rounded shadow" style="width: 100%; max-height: 450px; object-fit: cover;">
                </div>
            </div>
        </div>
    ...
    <section id="services-2" class="services-2 section dark-background">
        <div class="container section-title" data-aos="fade-up">
            <h2>DAMPAK</h2>
            <p>Ancaman terhadap Ketahanan Nasional</p>
        </div><!-- End Section Title -->
                        ...
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-item-contents">
                                    <a href="#">
                                        <span class="service-item-category">Kekeringan</span>
                                        <h2 class="service-item-title">Lahan</h2>
                                    </a>
                                </div>
                                <img src="{{ asset('assetslp/img/langka.jpg') }}" alt="Image" class="img-fluid">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-item-contents">
                                    <a href="#">
                                        <span class="service-item-category">Gizi</span>
                                        <h2 class="service-item-title">Buruk</h2>
                                    </a>
                                </div>
                                <img src="{{ asset('assetslp/img/langka1.jpg') }}" alt="Image" class="img-fluid">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-item-contents">
                                    <a href="#">
                                        <span class="service-item-category">Pembuangan</span>
                                        <h2 class="service-item-title">Hasil Panen</h2>
                                    </a>
                                </div>
                                <img src="{{ asset('assetslp/img/langka2.jpeg') }}" alt="Image" class="img-fluid">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-item-contents">
                                    <a href="#">
                                        <span class="service-item-category">Antrian</span>
                                        <h2 class="service-item-title">Sembako</h2>
                                    </a>
                                </div>
                                <img src="{{ asset('assetslp/img/langka3.jpeg') }}" alt="Image" class="img-fluid">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-item-contents">
                                    <a href="#">
                                        <span class="service-item-category">Pembagian</span>
                                        <h2 class="service-item-title">Bahan Pangan</h2>
                                    </a>
                                </div>
                                <img src="{{ asset('assetslp/img/langka5.jpeg') }}" alt="Image" class="img-fluid">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-item">
                                <div class="service-item-contents">
                                    <a href="#">
                                        <span class="service-item-category">Gagal</span>
                                        <h2 class="service-item-title">Panen</h2>
                                    </a>
                                </div>
                                <img src="{{ asset('assetslp/img/langka4.jpeg') }}" alt="Image" class="img-fluid">
                            </div>
                        </div>
                    </div>
    ...
    <!-- Recent Posts Section (Placeholder, as original is incomplete) -->
