        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown me-1">
                <a class="nav-link count-indicator dropdown-toggle d-flex justify-content-center align-items-center"
                    ...
                    <span class="count bg-info">3</span>
                </a>
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content">
                            <h6 class="preview-subject font-weight-normal">Data Baru</h6>
                            <p class="font-weight-light small-text mb-0 text-muted">Data produksi baru dari Jawa Barat
                            </p>
                        </div>
                    </a>
                </div>
        ...
        <ul class="navbar-nav me-lg-2">
            <li class="nav-item nav-search d-none d-lg-block">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Cari Data..." aria-label="search"
