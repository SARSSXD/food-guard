...
<body>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Cadangan Pangan Indonesia
                        @if($pendingCount > 0)
                    ...
                    <!-- Form Pencarian -->
                    <form method="GET" action="{{ route('nasional.cadangan.index') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <a href="{{ route('nasional.cadangan.export', request()->only(['wilayah', 'tahun', 'komoditas'])) }}" class="btn btn-success ms-2">Ekspor CSV</a>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @forelse ($cadanganPangan as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('nasional.cadangan.show', $item->id) }}" class="btn btn-info btn-sm">Detail</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
