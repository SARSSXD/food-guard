...
<head>
    ...
    <title>Cadangan Pangan Indonesia</title>
...
<body>
    ...
    @section('content')
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Cadangan Pangan Indonesia
                @if ($pendingCount > 0)
                    <a href="{{ route('nasional.cadangan.pending') }}" class="badge badge-warning ms-2">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('nasional.cadangan.index') }}">
                        <div class="row">
            ...
            <!-- Tabel Data -->
            @if ($cadanganPangan->isNotEmpty())
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Daftar Cadangan Pangan Agregat</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="cadanganTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach ($cadanganPangan as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('nasional.cadangan.show', $item->id) }}"
                        ...
                        <!-- Form Ekspor -->
                        <form method="POST" action="{{ route('nasional.cadangan.export') }}" class="mt-4">
                            @csrf
            ...
            @elseif (request('wilayah') || request('tahun') || request('komoditas'))
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <p class="text-gray-600">Tidak ada data cadangan pangan agregat untuk filter yang dipilih.</p>
                    </div>
                </div>
            @else
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <p class="text-gray-600">Tidak ada data cadangan pangan agregat tersedia.</p>
                    </div>
                </div>
            @endif
        </div>
